...
final class ConfigurationConverterExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        $container->setParameter('configuration_converter.serializer_group.default_export_dir', $config['serializer_group']['default_export_dir']);
        $container->setParameter('configuration_converter.serializer_group.entities_dir', $config['serializer_group']['entities_dir']);
